...
public class imageFullScreenFragment extends Fragment implements View.OnClickListener {
    ...
    public static imageFullScreenFragment newInstance(challengeSlotDetail CSD, String imagePath, long cacheKey) {
        imageFullScreenFragment fragment = new imageFullScreenFragment();
        Bundle args = new Bundle();
        args.putParcelable("CSD", CSD);
        args.putString("imagePath", imagePath);
        args.putLong("cacheKey", cacheKey);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            CSD = getArguments().getParcelable("CSD");
            imagePath = getArguments().getString("imagePath");
            cacheKey = getArguments().getLong("cacheKey");
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        super.onCreate(savedInstanceState);
        ctx = getContext();
        rootView = inflater.inflate(R.layout.activity_image_full_screen_view, container, false);
        imgView = rootView.findViewById(R.id.fullscreen_ImageView);

        title = rootView.findViewById(R.id.fullscreen_title);
        chName = rootView.findViewById(R.id.fullscreen_ch);
        likeView = rootView.findViewById(R.id.fullscreen_likeNum);
        date = rootView.findViewById(R.id.fullscreen_postDate);
        desc = rootView.findViewById(R.id.fullscreen_desc);
        likeButton = rootView.findViewById(R.id.fullscreen_likeImg);
        RelativeLayout innerView = rootView.findViewById(R.id.fullImageFragment_innerLayout);
        innerView.setLayoutParams(new FrameLayout.LayoutParams
